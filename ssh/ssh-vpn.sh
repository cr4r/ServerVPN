...
curl https://${pssh}/nginx.conf >/etc/nginx/nginx.conf
curl https://${pssh}/vps.conf >/etc/nginx/conf.d/vps.conf
...
wget -O /home/vps/public_html/index.html "https://${pssh}/index.html1"
